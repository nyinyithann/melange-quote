/*
  Thanks to all the original creators of Resotrative! (https://github.com/paulshen/restorative)

  I copy the entire file so that I don't need to add ReasonReact package.
 */
